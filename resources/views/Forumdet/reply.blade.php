            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                                <h4 class="card-title">帖子详情</h4></div>
                            <div class="col-md-5">
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td colspan="4">
                                        ...
                                        <form class="form-sample" action="{{url('forumdet/replyForum')}}" method="post">
                                            {{csrf_field()}}
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">请输入回复内容</label>
                                                        <div class="col-sm-9">

                                                            @foreach($result as $k => $v22)
                                                            <input type="hidden" name="theme_id" value="{{$v22->zuichu_id}}">
                                                            @endforeach
                                                            <input style="width: 500px;height: 200px;" type="text" name="text" class="form-control" placeholder="请输入回复内容"/>
                                                        </div>
                                                    </div>
                                                </div>
