    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h4 class="card-title"><b> 教师管理</b></h4>
                <div class="template-demo ">
                    <div class="row">
                        <div class="col-md-8">
                            <form class="form-sample" action=" {{url('user/selUser')}}" method="post" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="sMajor" value="" class="form-control" placeholder="请输入老师姓名工号"/>
                                        <input type="hidden" name="role" value="teacher" class="form-control"/>
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="col-md-4">
                            <button id="addTeacher" type="button" class="btn btn-inverse-primary btn-md">添加教师</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body" id="form" style="{{count($errors) > 0?'':'display: none;'}}">
                    ...
                    <p class="card-description">
                        请在下面 <code>输入框中</code> 填入老师相关信息
                    </p>

                    <form class="form-sample" action="{{url('/user/add')}}?type=101" method="post">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" name="te_id" class="form-control" placeholder="请输入教师工号"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" name="te_name" class="form-control" placeholder="请输入教师姓名"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="forms-sample" action="{{url('/user/updateUser')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="uaccount" id="uaccount" class="form-control" placeholder="请输入教师工号"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">姓名</label>
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="ute_name" id="uname" class="form-control" placeholder="请输入教师姓名"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">院系</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" name="ute_tel" id="utel" class="form-control" placeholder="请输入教师手机号"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">民族</label>
